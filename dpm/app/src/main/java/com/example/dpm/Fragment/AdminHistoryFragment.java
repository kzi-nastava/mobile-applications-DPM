...
import com.example.dpm.Adapter.AdminRideAdapter;
...
public class AdminHistoryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new AdminRideAdapter(filteredRides, ride -> {
        ...
        repo.getPastRidesForAdmin(rides -> {
    ...
    private void showSortDialog() {
        String[] options = { "Start time", "End time", "Price", "Route", "PANIC", "Cancelled" };
        ...
        new android.app.AlertDialog.Builder(requireContext())
                ...
                .setItems(options, (d, which) -> {
                    ...
                    switch (which) {
                        case 0:
                            Collections.sort(filteredRides, (a, b) -> safe(a.getStartTime()).compareTo(safe(b.getStartTime())));
                            break;
                        case 1:
                            Collections.sort(filteredRides, (a, b) -> safe(a.getEndTime()).compareTo(safe(b.getEndTime())));
                            break;
                        case 2:
                            Collections.sort(filteredRides, (a, b) -> Double.compare(b.getPrice(), a.getPrice()));
                            break;
                        case 3:
                            Collections.sort(filteredRides, (a, b) -> getRoute(a).compareTo(getRoute(b)));
                            break;
                        case 4:
                            Collections.sort(filteredRides, (a, b) -> Boolean.compare(b.isPanicTriggered(), a.isPanicTriggered()));
                            break;
                        case 5:
                            Collections.sort(filteredRides, (a, b) -> Boolean.compare(isCancelled(b), isCancelled(a)));
                            break;
                    }
    ...
    private boolean isCancelled(Ride r) {
        return r.getCancelReason() != null && !r.getCancelReason().isEmpty();
    }
    ...
    private Date parseDateSafe(String dt) {
        ...
        try { return df.parse(dt); }
        catch (ParseException e) { return new Date(0); }
    }
